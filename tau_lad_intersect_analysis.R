...
# Import
LAD_peaks <- import("../LAD domains/sorted_GSM5669198_D5Midbrain_LADs_mm39.bed",
                    format = "BED")
enriched_KD_peaks <- import("differential_analysis/enriched_KD_masterPeak_sep.ucsc.bed",
                            format = "BED")
lost_KD_peaks <- import("differential_analysis/lost_KD_masterPeak_sep.ucsc.bed",
                        format = "BED")
enriched_OE_peaks <- import("differential_analysis/enriched_OE_masterPeak_sep.ucsc.bed",
                            format = "BED")
lost_OE_peaks <- import("differential_analysis/lost_OE_masterPeak_sep.ucsc.bed",
                        format = "BED")

len_LAD_peaks <- length(LAD_peaks)
...
LAD_peaks <- filterChromosomes(LAD_peaks, organism = "mm39", chr.type =
                                 "canonical")
